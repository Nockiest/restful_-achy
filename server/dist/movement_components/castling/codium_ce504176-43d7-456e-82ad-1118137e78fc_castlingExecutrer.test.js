...
describe('changeIndex', () => {
    // should not execute a castle if the castling pattern is null
    it('should not execute a castle if the castling pattern is null', () => {
        ...
        castlingExecutor.getCastlingPattern = jest.fn().mockReturnValue(null);
        castlingExecutor.changeIndex(6, grid);
        // Assert that the castle was not executed
        // ...
    });
});
