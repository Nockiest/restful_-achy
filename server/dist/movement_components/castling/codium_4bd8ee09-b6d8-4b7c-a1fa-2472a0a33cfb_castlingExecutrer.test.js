...
describe('changeIndex', () => {
    // should not execute a castle if the accompanying piece is null
    it('should not execute a castle if the accompanying piece is null', () => {
        ...
        grid.getPieceAtIndex = jest.fn().mockReturnValue(null);
