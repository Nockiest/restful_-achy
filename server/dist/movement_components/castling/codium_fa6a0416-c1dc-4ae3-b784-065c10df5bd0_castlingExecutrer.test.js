...
describe('changeIndex', () => {
    // should not change the index of the piece if the given index is out of bounds
    it('should not change the index of the piece if the given index is out of bounds', () => {
        ...
        castlingExecutor.changeIndex(64, grid);
        // Assert that the index was not changed
        // ...
    });
});
